      ...
      <ContainerX className="mt-32 justify-center md:!items-center lg:mt-0 max-h-fit relative z-30 ">
        ...
        <Image className="xxs:p-2 xsm:p-2 sm:p-20 md:p-20 lg:p-0 xl:p-0 ">
          <ImageC>
            <BlockNFT>
              <div className="mask">
                <LeftArrow className="hover:cursor-pointer" onClick={slidePrev} />
                <Truck className="img-wrapper">
                  <img
                    src={content.carouselImageNames[currentSlide]}
                    alt=""
                    className="ph"
                  />
                </Truck>
                <RightArrow className="hover:cursor-pointer" onClick={slideNext} />
              </div>
            </BlockNFT>
          </ImageC>
        </Image>
